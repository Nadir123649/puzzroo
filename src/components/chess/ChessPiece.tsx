...
export function ChessPiece({
  ...
  return (
    <div
      className={cn(
        'relative w-full h-full flex items-center justify-center p-1 sm:p-1.5 md:p-2 transition-transform duration-200 ease-out select-none cursor-pointer group-hover:scale-105',
        className
      )}
    >
