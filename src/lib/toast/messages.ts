...
export const ToastMessages = {
  ...
  AUTH_INTERNAL_ERROR: 'Google sign-in hit an internal error. Please try again.',
  AUTH_NONCE_INVALID: 'Sign-in session expired. Please try again.',
  AUTH_REDIRECT_FAILED: 'Social sign-in could not be completed. Please try again.',
  AUTH_DUPLICATE_CREDENTIAL: 'This email is already linked to another sign-in method. Log in with your existing method instead.',
