...
import { Clock, ShieldCheck, Send, HelpCircle, Mail } from 'lucide-react'
  ...
  return (
    <>
      ...
      <InfoPageLayout title="Contact Us">
        ...
        {/* Success State - always in DOM, shown/hidden via display */}
        <div style={{ display: isSubmitted ? 'flex' : 'none' }} className="flex-col items-center gap-6 bg-white dark:bg-[#1F222A] rounded-[24px] p-8 text-center border-[1.5px] border-[#E0E0E0] dark:border-[#35383F] shadow-lg max-w-[560px] mx-auto">
          <div className="w-16 h-16 bg-[#6949FF] rounded-full flex items-center justify-center text-white text-3xl font-bold">
            ✓
          </div>
          <div>
        ...
        {/* Form State - always in DOM, shown/hidden via display */}
        <div style={{ display: isSubmitted ? 'none' : 'grid' }} className="md:grid-cols-12 gap-6 items-stretch">
          
          {/* Left Column: Info Cards */}
          <div className="md:col-span-5 flex flex-col gap-4">
            
            {/* Contact Card */}
            <div className="bg-[#FAF9FF] dark:bg-[#1F222A] border-[1.5px] border-[#E0E0E0] dark:border-[#35383F] rounded-2xl p-5 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center flex-shrink-0">
                    <Mail size={16} className="text-[#6949FF]" strokeWidth={2} />
                  </div>
                  <div>
